...
int main() {
    ...
    while (1) {
        ...
        while (scanf("%d", &userChoice) != 1 || userChoice < 1 || userChoice > 5) {
            printf("\nInvalid input. Please enter a number within 1 and 5\n");
        ...
        switch (userChoice) {
            ...
            case 2:
                ...
                while (scanf("%d", &userChoice) != 1 || userChoice < 1 || userChoice > 6) {
                    printf("\nInvalid input. Please enter a number within 1 and 6\n");
            ...
            case 3:
                ...
                while (scanf("%d", &userChoice) != 1 || userChoice < 1 || userChoice > 2) {
                    printf("\nInvalid input. Please enter a number within 1 and 2\n");
                    printf("Enter your choice: ");
                    while (getchar() != '\n');
                }
